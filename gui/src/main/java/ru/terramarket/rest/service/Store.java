...
import ru.terramarket.rest.dto.StoreDTO;
 ...
 * Time: 16:12
 */
public class Store extends TMRestServiceBase{
    ...
    public static class DoCreateJson {
        ...
        public StoreDTO putAsStoreDTO(String json) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (json == null) {
            }
            if (json!= null) {
