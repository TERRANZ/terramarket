...
import ru.terramarket.rest.dto.UserDTO;
 ...
 * Time: 16:11
 */
public class Login extends TMRestServiceBase {
    ...
    public DoLoginJson doLoginJson() {
        return new DoLoginJson(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
    }
