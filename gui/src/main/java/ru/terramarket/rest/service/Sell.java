...
import ru.terramarket.rest.dto.SellDTO;
 ...
 * Time: 16:12
 */
public class Sell extends TMRestServiceBase {
    ...
    public DoSellJson doSellJson() {
        return new DoSellJson(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
    }
    ...
    public static class DoCreateJson {
        ...
        public SellDTO putAsSellDTO(String json) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (json == null) {
            }
            if (json!= null) {
