...
import ru.terramarket.rest.dto.ProductDTO;
 ...
 * Time: 16:11
 */
public class Product extends TMRestServiceBase {
    ...
    public static class DoCreateJson {
        ...
        public ProductDTO putAsProductDTO() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            com.sun.jersey.api.client.WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
            resourceBuilder = resourceBuilder.accept("application/json");
        ...
        public ProductDTO putAsProductDTO(String json) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (json == null) {
            }
            if (json!= null) {
    ...
    public static class DoListJson {
        ...
        public ListDTO<ProductDTO> getAsListDTO() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            com.sun.jersey.api.client.WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
            resourceBuilder = resourceBuilder.accept("application/json");
